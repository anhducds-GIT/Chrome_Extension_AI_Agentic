(() => {
  ...
  // F-08: timeout_sec is the GENERATING budget after the credit is already spent,
  // so a tight ceiling loses a paid video and hard-stops the batch. 175s worst
  // case measured across 9 live jobs (02/09), 600 = 3.4x that.
