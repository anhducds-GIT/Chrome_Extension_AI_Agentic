...
(() => {
  ...
  const MESSAGES = Object.freeze({
    ...
    // --- Output location ----------------------------------------------------
    OUTPUT_DESTINATION_MISSING: { label: "Chưa chọn nơi lưu", guidance: "Chọn thư mục lưu video trước khi chạy." },
    ...
    OUTPUT_COLLISION_OVERWRITE_ACTIVE: { label: "Đang bật chế độ ĐÈ LÊN video cũ", guidance: "Job nào chạy lại với cùng tên file sẽ xoá mất video cũ. Vào Naming, đổi Collision policy sang 'Keep both — add number' nếu muốn giữ video cũ." },
    ...
    RESUME_RECREATE_INCOMPLETE: { label: "Lần tạo lại chưa hoàn tất", guidance: "Job này chưa có video nào được lưu và xác minh. Bấm Recreate để tạo lại một lần nữa." },
