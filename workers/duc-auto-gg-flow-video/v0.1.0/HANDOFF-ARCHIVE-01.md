# HANDOFF-ARCHIVE-01 — `workers/duc-auto-gg-flow-video/v0.1.0`

> **Đây là phần đuôi đã cắt của `HANDOFF.md` cạnh file này.** Cắt ngày 2026-09-06 theo
> [ADR-0008](../../../docs/adr/0008-cat-duoi-handoff-giu-hai-muoi-luot.md), phiên `claude-handoff-cat`.
>
> Cắt theo **vị trí trong file**, không theo ngày (bất biến ⑵ của ADR): `HANDOFF.md` giữ 20 mục
> cuối, 183 mục trước đó nằm ở đây — **nguyên văn, không sửa một chữ, không xoá một dòng**.
> Các mục trong file này **không xếp theo thứ tự thời gian**; thứ tự là thứ tự chúng vốn nằm
> trong file gốc.
>
> Ghép phần dưới dấu `ARCHIVE-BODY-START` vào đúng chỗ con trỏ trong `HANDOFF.md` là dựng lại
> được bản gốc **giống hệt từng byte** — SHA-256 bản gốc trước khi cắt: `93b18197e65738031ae6281febb9b4fd6c229240cefe6816d6258847a6d93a10`.
>
