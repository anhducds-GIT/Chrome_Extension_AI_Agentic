...
- **0027 — *"Không tự ý commit — luôn hỏi Đức trước"*.** Chết **24/08**: quyết định **0028** thay hẳn trong phạm vi project này (AI được `git commit` kể cả vào `main`, với bốn điều kiện an toàn), và **0033** nhắc lại. `AGENTS.md` của gói luật 6 mang bản đang sống.
