...
owner: claude
priority_rank: 2
next_step: "**B-40, B-41, B-42, B-43, B-44 đã đóng** (09/09). Không còn mục nào làm được mà không cần Đức. Hai mục chờ Đức chốt, cả hai là chuyện LUẬT: `B-45` (cho phép quy thuộc một ảnh sau cú F5 hay không — F5 xoá bằng chứng quy thuộc, nên hôm nay một job đã có ảnh mà bộ dò mù vẫn phải người xem) và `B-36` (một nút cấp lại quyền thư mục, chỉ còn là bất tiện sau ADR-0051). Và `B-42` còn một vế của điều kiện đóng mà tôi KHÔNG được tự làm: **audit độc lập** — không tự ký nghiệm thu bản sửa của chính mình."
