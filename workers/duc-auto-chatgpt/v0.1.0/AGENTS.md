...
| `tests/chatgpt-zoom-control-smoke.mjs` | **FILE CHẾT — chờ Đức cho xoá** (N-14). Không ghim gì cả: đo ở gói Gemini là 9 đột biến vào `sidepanel.js` mà XANH cả 9. Giữ lại vì xoá file cần Đức duyệt; đầu file có ghi rõ |
