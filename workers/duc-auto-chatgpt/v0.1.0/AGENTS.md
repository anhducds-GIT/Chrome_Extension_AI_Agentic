...
| `HANDOFF-ARCHIVE-01.md` · `HANDOFF-ARCHIVE-02.md` · `HANDOFF-ARCHIVE-03.md` · `HANDOFF-ARCHIVE-04.md` · `HANDOFF-ARCHIVE-05.md` · `HANDOFF-ARCHIVE-06.md` | Đuôi đã cắt của `HANDOFF.md`, nguyên văn, **chỉ đọc** — ghép lại dựng được bản gốc giống hệt **từng byte** (ADR-0008 gốc repo ⑴) |
