(() => {
  ...
  const GLOSSARY = Object.freeze([
    ...
    ["OUTPUT", "Persistence verified", "Tệp đã ghi được mở lại và xác minh là không rỗng. Chỉ khi đó trạng thái mới được hiển thị là Đã lưu."],
    ["OUTPUT", "Detected not downloaded", "Đã xác định được đầu ra, nhưng chức năng tải ảnh xuống đang tắt; vì vậy không có tệp ảnh nào được lưu."],
