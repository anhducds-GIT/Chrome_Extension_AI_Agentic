...
assert.equal(runner.canRetry({ ...retryItem, phase: "SUBMITTED" }, "TIMEOUT_AFTER_SUBMIT"), false, "B-19 (Đức chốt 06/09): sau khi đã gửi thì không tự gửi lại — xem tests/post-submit-no-resend-smoke.mjs");
