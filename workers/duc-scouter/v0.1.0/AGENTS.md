...
| `scripts/scouter-mutation-check.mjs` | 91 con đột biến: khung seed, đường ghi, cái phanh, bề mặt quyền, lệnh gọi mạng (`F1..F6`) **vùng ghi** (`G1..G3`, `H1..H3`) và **sổ công việc** (`J1..J10`). Con số này mục theo code — đếm lại bằng chính bộ đo, đừng tin dòng này |
