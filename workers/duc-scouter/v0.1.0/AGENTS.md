...
| `scripts/scouter-mutation-check.mjs` | 81 con đột biến: khung seed, đường ghi, cái phanh, bề mặt quyền, lệnh gọi mạng (`F1..F6`) và **vùng ghi** (`G1..G3`, `H1..H3`). Con số này mục theo code — đếm lại bằng chính bộ đo, đừng tin dòng này |
