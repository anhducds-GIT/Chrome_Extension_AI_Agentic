 ...
 * nó nguy hiểm nhất. */
const EXPECTED_WRITE_METHODS = new Set(["scout.reload", "scout.click", "scout.chon", "scout.hover", "scout.scroll", "scout.history", "scout.type", "scout.key", "scout.clear", "scout.fetch", "scout.grab", "scout.navigate"]);
