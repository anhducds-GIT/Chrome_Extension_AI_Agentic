...
owner: claude
priority_rank: 4
next_step: "Lo trinh A1-A5 con A4 (ba cho qua ngan sach) va A5 (22 noi luat qua han ra) — nhung A4 DANG CO LANE KHAC dong toi (docs/adr/0038 + docs/archive/ hien trong cay lam viec), hoi truoc khi gianh. A1 A2 A3 dong 17/09 (2bdb1cce, d7c2f601). Xong A4+A5 moi toi D2 (audit doc lap, CAN DUC MO KENH) — va D2 phai mo bang CO DO TUOI: bat ben kia doc CHUOI-VIEC.md tren main, khong thay khoi A1-A5 thi DUNG, connector dang phuc vu ban cu (ca that 17/09: GPT bao SHA fbb1bd6f khong resolve, do lai thi no co tren origin/main tu 17:44). Sau D2 la D4: rut phan dung chung khoi udin-optic/tu-dong/ (2.007 dong dang chay that) ma KHONG de them mot ban fork — dieu khoan (1) phai noi ve ranh gioi chep/fork, vi 4 loi cua hai goi giong nhau 0 dong khac tren 3.874 dong o cho CO ghim, va da troi o cho KHONG co ghim (do la S-32). N1 van mo nhung cho DU LIEU: cho mot lan may chu Bridge chet that roi doc nhat ky doi song."
human_action: "CO — mot viec duy nhat: mo kenh cho D2 (Codex hoac GPT) khi A4+A5 xong. AI khong tu gui gi ra ngoai."
