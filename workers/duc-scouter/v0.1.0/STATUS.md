...
current_focus: "Bo kiem cai dat co hai chot dung dao. Mot: cong tac ghi DONG khong phai hong — do la mac dinh va la mot lop bao ve (luat goi so 8); khai no thanh hong la day nguoc luat. Hai: buoc dau phai hoi bridge.sessions chu khong system.ping — ping di toi extension nen tren may co hai ghe no tra TARGET_AMBIGUOUS, tuc buoc chan doan chet vi dung cai no di tim (G-91, cung ho G-81). 35 phep ghim xanh, 5 mutant cua bo kiem deu chet."
