...
current_focus: "CHANG (3): T8 xong, T16 xong — trang thu tu ke trang thai bang CHU, doc mot luot bang scout.text, het phai doan gia tri data-*. Hai bai hoc dat: bo dot bien phep do da TOI tu 12/09 vi chi chay sau mot co khong ai truyen (nay gop vao scouter:mutation), va DUNG CU DO phai song duoc duoi dung dieu kien dang do (G-81). Cho chan that su cua (3) la S-22."
