...
current_focus: "Lo trinh T21 tu SAU chang xuong NAM: chang gop transport.mjs ve _shared DA CHET (G-92). Loi may chu Bridge gop duoc vi no la tien trinh Node; transport.mjs chay BEN TRONG extension, ma Chrome nap thu muc v0.1.0 lam goc goi nen moi import vuot len tren goc bi kep lai — service worker khong dang ky duoc. Ranh gioi Node/Chrome moi quyet dinh gop duoc hay khong, khong phai so dong giong nhau. Hai ban transport hom nay giong nhau TUNG BYTE va ADR-0021 (2) da chot san duong chep-nguyen-van + phep ghim so tung byte. Dong dau Scouter v1 van DE LAI cho toi khi T21 dong voi git status workers/duc-scouter SACH."
