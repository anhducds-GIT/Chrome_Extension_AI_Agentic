...
current_focus: "CHANG (3): T8 xong, T16 xong. Bai hoc dat nhat cua luot nay la mot LOI CUA TOI: toi dung G-82 de mo lai S-22 lan thu SAU, trong khi ve dau da nam san o README ("hong theo tung tab") va ve sau chinh la G-07 da chet va da kiem lai hai lan. Thu toi goi la so lieu moi chi la mot tuong quan dem lai. G-82 nay la cai chan: ba so chuot=0 phim=0 bam=0 tren trang thu KHONG phai bang chung moi ve S-22."
