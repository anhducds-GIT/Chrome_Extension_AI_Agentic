...
# ADR-0043 — Chỉ cuộn khi ảnh đang KHÔNG hiện ra, và chỉ khi đã hết trạng thái đang-sinh-ảnh.

## Bối cảnh

Can thiệp trang ở mức tối thiểu. Test ghim: khối cuộn không được chứa click/gõ/dispatchEvent.

Nhóm trong bản ghi gốc: 2026-08-26 (vòng 2) — Đưa ảnh vào tầm mắt rồi mới đo, KHÔNG nới lớp kiểm (owner: Đức).

## Quyết định

Chỉ cuộn khi ảnh đang KHÔNG hiện ra, và chỉ khi đã hết trạng thái đang-sinh-ảnh.
