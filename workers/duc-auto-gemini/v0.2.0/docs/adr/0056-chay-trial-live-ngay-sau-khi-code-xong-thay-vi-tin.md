...
# ADR-0056 — Chạy trial live ngay sau khi code xong, thay vì tin suite xanh là đủ.

## Bối cảnh

Đức đề xuất. Đúng: suite 79/79 xanh mà trial vẫn lòi ra một lỗi mà không test tĩnh nào bắt được.
...
Chạy trial live ngay sau khi code xong, thay vì tin suite xanh là đủ.
