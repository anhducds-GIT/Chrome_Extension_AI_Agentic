...
# ADR-0040 — Mọi lần chờ đều ghi vào sổ cái

## Bối cảnh

Chính là bằng chứng để biết cách chờ này có ăn thật hay không — Đức chọn "chờ xem" thì phải đo được.
...
Mọi lần chờ đều ghi vào sổ cái: chờ bao lâu, có đổi được không, có hết hạn không.
