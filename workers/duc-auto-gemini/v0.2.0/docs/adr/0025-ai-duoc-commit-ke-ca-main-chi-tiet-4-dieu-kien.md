...
# ADR-0025 — AI được commit kể cả main (chi tiết + 4 điều kiện
...
AI được commit kể cả main (chi tiết + 4 điều kiện: xem dòng SUPERSEDES ở bảng Vận hành/UI phía trên)
...
Nguồn gốc: Audit 2026-08-24, điểm chốt #5 (Đức nới rộng)
