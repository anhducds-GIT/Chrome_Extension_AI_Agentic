...
function instanceAuth(instanceId, label) {
  return { type: "auth", role: "extension", token, instance: { schema_version: 1, instance_id: instanceId, label, worker: "duc-auto-gemini", extension_version: "0.1.0" } };
}
...
assert.equal(dirOne.result.sessions[0].worker, "duc-auto-gemini");
