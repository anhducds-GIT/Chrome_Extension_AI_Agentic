(() => {
  ...
  const GLOSSARY = Object.freeze([
    ...
    ["SETUP", "Safety cooldown", "Khoảng giữ thêm sau khi ChatGPT vừa đạt trạng thái READY. Có thể nhập một số cố định hoặc dải như 6-9; extension chọn một số nguyên cho mỗi readiness gate, chờ đủ thời gian rồi kiểm tra READY lần nữa. Khoảng này khác với Inter-job delay."],
    ...
    ["RUN", "Waiting for ChatGPT ready", "Extension đang xác minh trình soạn thảo ở trạng thái rảnh. Việc bộ đếm thời gian kết thúc không tự nó cho phép gửi prompt."],
    ...
    ["OUTPUT", "Artifact persistence failed", "Phần tạo ảnh có thể đã hoàn tất, nhưng ít nhất một artifact không ghi được hoặc không vượt qua bước mở lại để xác minh. Xem bảng Run Artifacts để biết Images, Result XLSX hay Audit JSONL bị lỗi; giữ nguyên output trong ChatGPT cho đến khi đã bảo toàn tệp."],
