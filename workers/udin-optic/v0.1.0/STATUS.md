...
priority_rank: 5
next_step: "CA HAI CA CUA DUC DEU CHAY TRON BANG MOT LENH, do that 17/09: (a) anh Udin tu sinh --anh canvas:<mau src>; (b) anh tu ngoai --anh <duong vung ghi>, tha bang scout.tha. Bay chang W1 -> NGUON -> CHON -> W2 -> W3 -> JPG -> W4. Khong mot hop thoai nao (do 0/14 va 0/11). Danh tinh anh canvas la data-image-id (ADR-0009). Man chan User Limit Reached la BUG cua Udin — Duc chot 17/09 "cu an"; quaManCho bam lai toi 12 luot, do that tat o cu dau. Con mo: S-31 (Udin khong tu nap lai duoc) — CAN DUC CHOT vi mo lai la them mot method Bridge. R2 va R3 PARKED."
human_action: "khong"
