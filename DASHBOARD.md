...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (109 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 24 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | CHANG (3) DONG BANG SEED di duoc mot nua. T8 xong: het ten `observer` trong ma song, ghi chep co ngay thang giu ten cu co chu y (AGENTS.md co dong tra nguoc). T8 LO ra thu dat hon chinh no: bo dot bien phep do chi chay sau co --with-mutation nen khong cong nao chay, va BON mo neo muc tu 12/09 khong ai biet. Da neo lai, da gop ca hai bo vao mot lenh scouter:mutation. Cho chan con lai cua (3) la T7. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
