...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — migrate bộ khung 0.3.0 → 1.8.0; cổng cấu trúc còn ĐỎ ở B12 (42 ADR) và B16 — xem BACKLOG ([bằng chứng](HANDOFF.md)) | CÓ (46 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
