...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (132 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
