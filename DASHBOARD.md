...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (116 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 24 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | Trang thu hai bao ba cau KHONG cung mot nguon. O nhap: bao cao tra loi duoc, vi no luon co mat va HTML/ARIA khai ro. Cai nut: chinh TRANG tra loi, vi no co the chua ton tai luc do. Vung ket qua: chua ai tra loi duoc — ket qua la khai niem ngu nghia ma HTML khong danh dau, tren Udin no tinh co la mot bay img cung class. Bon mutant cua adapter deu chet, 34 phep ghim xanh, va luot chay that tren Udin sau khi doi thiet ke van khep: 4 anh moi trong 59 giay. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
