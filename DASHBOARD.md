...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (118 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 25 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | Lo trinh T21 tu SAU chang xuong NAM: chang gop transport.mjs ve _shared DA CHET (G-92). Loi may chu Bridge gop duoc vi no la tien trinh Node; transport.mjs chay BEN TRONG extension, ma Chrome nap thu muc v0.1.0 lam goc goi nen moi import vuot len tren goc bi kep lai — service worker khong dang ky duoc. Ranh gioi Node/Chrome moi quyet dinh gop duoc hay khong, khong phai so dong giong nhau. Hai ban transport hom nay giong nhau TUNG BYTE va ADR-0021 (2) da chot san duong chep-nguyen-van + phep ghim so tung byte. Dong dau Scouter v1 van DE LAI cho toi khi T21 dong voi git status workers/duc-scouter SACH. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
