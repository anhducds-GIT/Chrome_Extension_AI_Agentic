...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (110 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 24 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | CHANG (3): T8 xong, T16 xong. Bai hoc dat nhat cua luot nay la mot LOI CUA TOI: toi dung G-82 de mo lai S-22 lan thu SAU, trong khi ve dau da nam san o README ("hong theo tung tab") va ve sau chinh la G-07 da chet va da kiem lai hai lan. Thu toi goi la so lieu moi chi la mot tuong quan dem lai. G-82 nay la cai chan: ba so chuot=0 phim=0 bam=0 tren trang thu KHONG phai bang chung moi ve S-22. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
