...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (107 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 24 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | Hoan thien SEED dung chung roi moi tach Udin ra goi rieng — Duc dat lai 14/09. Thuoc do khong phai phan tram ma la DANH SACH DONG BANG o docs/CAPABILITIES.md muc 5.2: tap nang luc phai xong TRUOC khi tach, vi them mot lenh Bridge sau khi tach phai sua tay sau cho trong Scouter. Udin la CA THU, khong phai dich. Ngay 14/09 danh sach do gan het: O8 O11 I4 xong va da chay that; S-25 (loi nen) xong; I5 I6 I7 O12(nua ⑴) va N5 xong ma CHUA CHAY THAT. Con lai: I9 upload, va mot cau kien truc cho Duc chot (G-69). Cho rui ro lon nhat bay gio KHONG phai thieu nang luc — la khoang cach giua CO va DA CHUNG MINH: sau dong bang moi doi sang CO trong mot luot. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
