...
|---|---:|---|---:|---:|---|---|---|---|
| chrome-extension-ai-agentic | 0.3.0 | active | 0 | 32 | 2026-09-09 @ `4da1e9e` — cổng cấu trúc: nhóm CHẶN đạt hết (B12 44→0, xem N-65); npm test thoát 0 lần đầu từ 10/09 ([bằng chứng](HANDOFF.md)) | CÓ (117 commit) | Vừa lên khung 1.8.0: nhận bộ nén luật, Context Compiler, can-nang đo token, bảng sống. Cổng nay chặt hơn và đang nêu nợ có thật. | [STATUS](STATUS.md) |
...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 25 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | Udin-optic hom nay la 5 script + 5 phep ghim, 1.404 dong, va KHONG CO MOT DONG MA EXTENSION NAO — phu thuoc ra ngoai dung mot: goi-bridge.mjs. Nen hai kieu tach chenh nhau rat xa: goi dieu khien rieng chi doi 10 file, con extension rieng nhu hnx-fetch phai them manifest + background + bang ben + may chu Bridge + transport + giao thuc rieng, tuc ban sao THU TU cua tang transport trong repo nay. Phep kiem dong chang (3) khong doi kieu thu hai. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
