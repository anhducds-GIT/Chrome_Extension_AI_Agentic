...
| Duc Scouter (seed v0.1) | 0.1.0 | building | 0 | 25 | CHƯA KHAI KIỂM CHỨNG | KHÔNG ÁP DỤNG (chưa khai mốc commit) | Bo kiem cai dat co hai chot dung dao. Mot: cong tac ghi DONG khong phai hong — do la mac dinh va la mot lop bao ve (luat goi so 8); khai no thanh hong la day nguoc luat. Hai: buoc dau phai hoi bridge.sessions chu khong system.ping — ping di toi extension nen tren may co hai ghe no tra TARGET_AMBIGUOUS, tuc buoc chan doan chet vi dung cai no di tim (G-91, cung ho G-81). 35 phep ghim xanh, 5 mutant cua bo kiem deu chet. | [STATUS](workers/duc-scouter/v0.1.0/STATUS.md) |
