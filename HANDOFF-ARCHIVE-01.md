# HANDOFF-ARCHIVE-01 — gốc repo (`_root`)

> **Đây là phần đuôi đã cắt của `HANDOFF.md` cạnh file này.** Cắt ngày 2026-09-06 theo
> [ADR-0008](docs/adr/0008-cat-duoi-handoff-giu-hai-muoi-luot.md), lane `claude-cat-goc`.
>
> Cắt theo **vị trí trong file**, không theo ngày (bất biến ⑵ của ADR): `HANDOFF.md` giữ 20 mục
> cuối, 62 mục trước đó nằm ở đây — **nguyên văn, không sửa một chữ, không xoá một dòng**.
> File gốc có **hai hình dạng mục trộn lẫn**: 16 mục đầu là gạch đầu dòng trong mục `## Log`,
> 66 mục sau là tiêu đề `##` riêng. Các mục **không xếp theo thứ tự thời gian**; thứ tự ở đây là
> thứ tự chúng vốn nằm trong file gốc.
>
> Ghép phần dưới dấu `ARCHIVE-BODY-START` vào đúng chỗ con trỏ trong `HANDOFF.md` là dựng lại
> được bản gốc **giống hệt từng byte** — SHA-256 bản gốc trước khi cắt: `10d84f26ef28d0e6fb1be26dfc754f125c817e5aa4c7c77f7711545789a6dae0`.
>
