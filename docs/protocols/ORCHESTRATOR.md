...
> đi code một gói thì đọc **`workers/<gói>/<phiên-bản>/PHIEN.md`**, **và chỉ nó** —
> [ADR-0035](../adr/0035-mot-file-cho-mot-phien-gap.md); bó ấy máy sinh và tự chứa.
> *(Dòng này viết `AGENTS.md` + `HANDOFF.md` tới 17/09: sai từ 09/09, tốn ~12.000 token thừa.)*
>
...
> (09/09): `STATUS.md` vốn dựng đúng cho lúc mở, `HANDOFF.md` chuyển sang **nạp theo yêu cầu**
> — mở khi cần biết *phiên trước vấp gì*. Đo: **24.000–30.500 → ~7.800 token**.
