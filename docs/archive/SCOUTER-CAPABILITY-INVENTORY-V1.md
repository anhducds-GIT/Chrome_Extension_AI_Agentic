...
|---|---|
| Bấm bằng CDP khác bấm bằng JS chỗ nào | `EXP-14-INPUT-SEMANTICS-BROWSER-INPUT-REACH-STUDY-V0.md` *(đã xoá 08/09)* |
| Cây trợ năng + DOMSnapshot + CSS | `EXP-12-ACCESSIBILITY-DOMSNAPSHOT-CSS-SEMANTIC-OBSERVATION-STUDY-V0.md` *(đã xoá 08/09)* |
| Bơm adapter động bằng `userScripts` | `EXP-09-USER-SCRIPTS-DYNAMIC-ADAPTER-DELIVERY-STUDY-V0.md` *(đã xoá 08/09)* |
| Tài liệu ẩn `offscreen` | `EXP-10-OFFSCREEN-BROWSER-PROCESSING-RUNTIME-STUDY-V0.md` *(đã xoá 08/09)* |
| Mạng: DNR / webRequest / CDP | `EXP-11-NETWORK-CONTROL-PLANE-DNR-WEBREQUEST-VS-CDP-STUDY-V0.md` *(đã xoá 08/09)* |
| Cookie / storage / IndexedDB của phiên đăng nhập | `EXP-07-AUTHENTICATED-SESSION-COOKIE-STORAGE-IDB-REACH-STUDY-V0.md` *(đã xoá 08/09)* |
| Khung con và target lồng nhau | `EXP-04-NESTED-FRAME-WORKER-TARGET-REGISTRY-STUDY-V0.md` *(đã xoá 08/09)* |
| Chụp bằng chứng | `EXP-13-EVIDENCE-CAPTURE-RUNTIME-STUDY-V0.md` *(đã xoá 08/09)* |
...
`EXP-14-INPUT-SEMANTICS-BROWSER-INPUT-REACH-STUDY-V0.md` *(đã xoá 08/09)*. Kết luận của nó, chép nguyên:
